...
public class Bleah1Parser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Bleah1.g4"; }
	...
	public Bleah1Parser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).exitProg(this);
		}
	}
	...
	public static class StatContext extends ParserRuleContext {
		...
		public Token ID;
		public TerminalNode NEWLINE() { return getToken(Bleah1Parser.NEWLINE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode ID() { return getToken(Bleah1Parser.ID, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).enterStat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).exitStat(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).exitExpr(this);
		}
	}
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(28); ((ExprContext)_localctx).e = multExpr();
			...
			while (_la==T__4 || _la==T__3) {
				...
				case T__4:
					...
					setState(31); ((ExprContext)_localctx).e = multExpr();
				...
				case T__3:
					...
					setState(35); ((ExprContext)_localctx).e = multExpr();
					_localctx.value -= ((ExprContext)_localctx).e.value;
					}
					break;
				default:
	...
	public static class MultExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).enterMultExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).exitMultExpr(this);
		}
	}
	...
	public final MultExprContext multExpr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(43); ((MultExprContext)_localctx).e = atom();
			...
			while (_la==T__2) {
				...
				setState(46); ((MultExprContext)_localctx).e = atom();
	...
	public static class AtomContext extends ParserRuleContext {
		...
		public Token ID;
		public ExprContext expr;
		public TerminalNode INT() { return getToken(Bleah1Parser.INT, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode ID() { return getToken(Bleah1Parser.ID, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Bleah1Listener ) ((Bleah1Listener)listener).exitAtom(this);
		}
	}
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(54); ((AtomContext)_localctx).INT = match(INT);
			...
			case ID:
				enterOuterAlt(_localctx, 2);
				{
				setState(56); ((AtomContext)_localctx).ID = match(ID);
			...
			case T__1:
				...
				setState(59); ((AtomContext)_localctx).expr = expr();
	...
	public static final String _serializedATN =
		...
		"\2>?\7\3\2\2?@\b\6\1\2@B\3\2\2\2A8\3\2\2\2A:\3\2\2\2A<\3\2\2\2B\13\3\2"+
		"\2\2\b\17\34(*\65A";
